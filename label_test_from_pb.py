...
def recognize(jpg_path, pb_file_path, classes):
  with tf.Graph().as_default():
      ...
      with tf.Session(graph=graph) as sess:
          ...
          img = (img-128)*1.0/128
          t1 = time.time()
          final_result = sess.run(output, feed_dict={input_x:np.reshape(img, [-1, 224, 224, 3])})
          t2 = time.time()
...
if __name__=="__main__":
  ...
  jpg_path = "tf_files/flower_photos/daisy/21652746_cc379e0eea_m.jpg"
  pb_file_path="tf_files/retrained_graph.pb"
